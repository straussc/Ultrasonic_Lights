...
// Display SerialPrint Funktionen    
  ...
  // PIR Status else  
    ...
    if (pirState == HIGH)	{
      ...
      lcd1.clear();
	  lcd1.setCursor(1,0);
  	  lcd1.print("Keine Bewegung");
 
      //lcd1.setCursor(1,1); 
  	  //lcd1.print("System pausiert.");  //Aktuell fehlerhaft, Zeile lädt nicht neu.
      
      
      ResetLights0();
        
  delay(1000); // Warte 1 Sekunde vor der nächsten Abfrage
    }
  }
  
  // PIR Status else ENDE
